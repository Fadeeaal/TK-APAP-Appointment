...
import apap.ti.appointment2206082985.repository.DoctorDb;
...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public AppointmentServiceImpl(AppointmentDb appointmentDb, DoctorDb doctorDb, PatientDb patientDb) {
        this.webClient = WebClient.builder().baseUrl("http://example.com").build(); // Initialize with the appropriate base URL
